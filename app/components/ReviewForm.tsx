...
export default function ReviewForm({ onClose, onSuccess, activityData }: ReviewFormProps) {
    ...
    return (
        <div className="w-full max-w-2xl bg-white rounded-[32px] overflow-hidden shadow-xl mx-auto my-10 border border-gray-100 font-sans flex flex-col max-h-[90vh]">
            {/* Header - Fixed */}
